...
function HouseInputComponent(props) {
    return (
        <>
            <div className='mt-8'>
                <h3 className="text-lg">متراژ زمین</h3>
            ...
            <div className='mt-8'>
                <h3 className="text-lg">متراژ بنا</h3>
                <input className='mt-4 w-full border-2 border-gray-300 p-2 rounded outline-0 focus:border-2 focus:border-red-400' type="text" placeholder='متراژ به متر مربع' name="meterground" id=""/>
            ...
            <div className='mt-8'>
                ...
                <select className='mt-4 text-gray-500 w-full border-2 border-gray-300 p-2 rounded outline-0 focus:border-2 focus:border-red-400' type="text" placeholder='اجاره به تومان' name="tamdid" id="">
            ...
            <div className='mt-8'>
                <h3 className="text-lg">بالکن</h3>
                <select className='mt-4 text-gray-500 w-full border-2 border-gray-300 p-2 rounded outline-0 focus:border-2 focus:border-red-400' type="text"  name="balcon" id="">
                    <option className='hidden ' value=""> انتخاب</option>
                    <option value="yes">دارد </option>
                    <option value="no">ندارد</option>
                </select>
